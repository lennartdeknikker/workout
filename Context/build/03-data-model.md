...
export const exercise = pgTable('exercise', {
	...
	weightMin: numeric('weight_min', { precision: 6, scale: 2 }),
	weightMax: numeric('weight_max', { precision: 6, scale: 2 }),
	repsMin: integer('reps_min'),
	repsMax: integer('reps_max'),
	restMin: integer('rest_min'),
	restMax: integer('rest_max'),
	durationMin: integer('duration_min'),
	durationMax: integer('duration_max'),
	distanceMin: numeric('distance_min', { precision: 8, scale: 2 }),
	distanceMax: numeric('distance_max', { precision: 8, scale: 2 }),
	resistanceMin: numeric('resistance_min', { precision: 6, scale: 2 }),
	resistanceMax: numeric('resistance_max', { precision: 6, scale: 2 }),
